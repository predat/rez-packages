...
echo -e "[BUILD][ARGS] PYBIND11 VERSION: ${PYBIND11_VERSION}"
...
# We build pybind11.
echo -e "\n"
echo -e "[BUILD] Building pybind11-${PYBIND11_VERSION}..."
echo -e "\n"
...
echo -e "\n"
echo -e "[BUILD] Finished building pybind11-${PYBIND11_VERSION}!"
echo -e "\n"
