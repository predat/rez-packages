...
echo -e "[INSTALL][ARGS] OIIO VERSION: ${OIIO_VERSION}"

# We check if the arguments variables we need are correctly set.
# If not, we abort the process.
if [[ -z ${BUILD_PATH} || -z ${OIIO_VERSION} ]]; then
    echo -e "\n"
...
# We install OIIO.
echo -e "\n"
echo -e "[INSTALL] Installing OIIO-${OIIO_VERSION}..."
echo -e "\n"
...
echo -e "\n"
echo -e "[INSTALL] Finished installing OIIO-${OIIO_VERSION}!"
echo -e "\n"
